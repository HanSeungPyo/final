...
import com.finals.customer.NoticeService;
...
public class CustomerController {
	...
	public void noticeWrite(NoticeDTO noticeDTO,HttpServletRequest request){
		 System.out.println("에디터 컨텐츠값:"+request.getParameter("contents"));
